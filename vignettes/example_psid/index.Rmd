...
save(mdl_particip_m, mdl_particip_f,
     file = here("vignettes/example_psid/mdl_particip.RData"))
```
...
```r
load(here("vignettes/example_psid/mdl_particip.RData"))
...
df_indcp <- bind_rows(mdl_particip_m$df_indcp |> mutate(gender = "Men"),
                      mdl_particip_f$df_ind |> mutate(gender = "Women"))
```
...
plot_scatter <- function(gender) {
  ...
  df_indcp |>
    ...
    labs(x = "Years of Education",
         y = "Chile Penalties on Participation",
         title = gender) +
...
<div class="figure" style="text-align: center">
<img src="figure/unnamed-chunk-3-1.svg" alt="plot of chunk unnamed-chunk-3"  />
...
<div class="figure" style="text-align: center">
<img src="figure/unnamed-chunk-6-1.svg" alt="plot of chunk unnamed-chunk-6"  />
