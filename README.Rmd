...
individual-level child penalties.
This can be computed from the (naive) variance of the individual-level child penalties
subtracted by the estimated variance of the measurement errors.
